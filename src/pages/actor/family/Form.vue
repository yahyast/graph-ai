<template lang="pug">
    form.form-general(@submit.prevent="submit($event)")
        ...
        .form-general__body.w-full
            ...
            wysiwyg(v-model="model.family")
            
            //- span.field-message.text-red-500(v-if="$v.model.family.$error") This family is required.
...
export default {
    ...
    watch: {
        ...
        detail(newVal) {
            ...
            this.model.family = (newVal.family ? newVal.family : '');
        },
    },
    methods: {
        ...
        submit(e) {
            ...
            // update only
            this.$store.dispatch('actor/update', [this.id, this.model, 'family'])
            .then((resp) => {
